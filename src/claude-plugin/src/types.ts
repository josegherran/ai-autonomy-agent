// Shared types for the AI Autonomy Mapper MCP plugin
...
export interface Capability {
  ...
  zone: CapabilityZone;
  notes?: string;
  /** Task is repetitive or rule-based (derived from q4 answer) */
  repetitive?: boolean;
  /** Task requires high human judgment (derived from q5 answer) */
  highJudgment?: boolean;
  /** Task has ethical, regulatory, or accountability constraints (derived from q7/q8) */
  highRisk?: boolean;
  /** High data availability for this task (derived from q6 answer) */
  dataRich?: boolean;
}
