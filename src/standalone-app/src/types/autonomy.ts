...
export const EXPOSURE_BG: Record<ExposureScore, string> = {
  HUMAN: 'bg-blue-200 text-blue-900',
  MOSTLY_HUMAN: 'bg-green-200 text-green-900',
  SHARED: 'bg-yellow-200 text-yellow-900',
  MOSTLY_AI: 'bg-orange-200 text-orange-900',
  AI: 'bg-red-200 text-red-900',
}
